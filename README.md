...
- AI 写作面板
  ...
  - 一致性审看
- 写作技能预设
  - 流程规划：结合 `Novel Writer Workflow Guide` 拆解创作阶段、澄清问题和下一步任务
  - 章节任务卡：结合 `Claude-Code-Novel-Writer` 汇总章节目标、冲突、人物状态和伏笔
  - 创作工具箱：结合 `Build Your AI Writing Toolkit` 沉淀设定卡、人物卡和资料待查清单
  - 文风守门：结合 `Fiction Writing Voice Skill` 与本地 `humanize-novel-prose` 做去 AI 味和文风校准
  - Crucible 规划：提炼核心承诺、人物弧线和主题压力
  - Crucible 大纲：拆解场景目标、冲突、转折和结尾钩子
  - Crucible 写作：按场景目标和冲突继续正文候选稿
  - Crucible 编辑：从结构、节奏、动机和句子质感修订正文
- AI 模型临时切换
  - 自动
  - Kimi
  - GLM
